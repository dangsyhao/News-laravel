                                    ...
                                    <div class="panel panel-default">
                                        <div class="panel-body">
                                            ...
                                            <form class="form-horizontal" role="form" method="POST" action="{{route('admin.advertise-edit')}}">
                                                {{ csrf_field() }}
                                                <!--get id value!-->
                                                <input id="id" type="hidden" name="id" value="{{$row->id}}" required autofocus>
                                                <div class="form-group{{ $errors->has('customer') ? ' has-error' : '' }}">
                                                    <label for="customer" class="col-md-4 control-label">Customer Name</label>
                                                    <div class="col-md-6">
                                                        <input id="customer" type="text" class="form-control" name="customer" value="{{$row->customer}}" required autofocus>
                                                ...
                                                <div class="form-group{{ $errors->has('link') ? ' has-error' : '' }}">
                                                    ...
                                                    <div class="col-md-6">
                                                        <input id="link" type="text" class="form-control" name="link" value="{{$row->link}}" required autofocus>
                                                        @if ($errors->has('link'))
                                                            <span class="help-block">
                                                ...
                                                <div class="form-group{{ $errors->has('info') ? ' has-error' : '' }}">
                                                    <label for="info" class="col-md-4 control-label">Infomations</label>
                                                    <div class="col-md-6">
                                                        <textarea id="info" type="text" class="form-control" name="info" required autofocus>{{$row->info}}</textarea>
                                                        @if ($errors->has('info'))
                                                            <span class="help-block">
