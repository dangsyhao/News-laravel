          ...
          <div class="form-group{{ $errors->has('title') ? ' has-error' : '' }}">
            ...
            <div class="form-group{{ $errors->has('image_avatar') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <div class='d-flex flex-row'>
                                    <input id="image_avatar" type="text" class="form-control" name="image_avatar" value="{{ old('image_avatar') }}" required autofocus>
            ...
            <div class="form-group{{ $errors->has('quotes_content') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                ...
                                <textarea id="quotes_content" type="text" class="form-control" name="quotes_content" value="{{ old('quotes_content') }}" required autofocus></textarea>
