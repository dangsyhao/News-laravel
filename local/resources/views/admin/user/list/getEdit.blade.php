        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{route('admin.user.setEdit')}}">
                        {{ csrf_field() }}
                    ...
                    @foreach($getAuthorByUsersTable_edit as $row)
                        ...
                        <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                         ...
                         <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="email" type="text" class="form-control" name="email" value="{{$row->email}}" disabled >
                                <input id="email-hidden" type="hidden" class="form-control" name="email" value="{{$row->email}}">
                                @if ($errors->has('email'))
                                    <span class="help-block">
                        ...
                        <div class="form-group{{ $errors->has('value') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <select id="value"  name="value" class="form-control admin-select-edit">
                        ...
                        <div class="form-group">
                            <div class="col-md-6">
                                ...
                                <a role="button" class="btn btn-primary " href="{{route('admin.user.getList')}}">Cancel</a>
                            </div>
                        </div>
                    @endforeach
                @endif        
