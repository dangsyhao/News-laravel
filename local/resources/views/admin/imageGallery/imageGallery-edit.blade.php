        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ route('admin.imageGallery-edit') }}">
                    {{ csrf_field() }}
                @if(isset($advertise_edit))
                    @foreach($advertise_edit as $row)
                        ...
                        <div class="form-group{{ $errors->has('image_category') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="image_category" type="text" class="form-control" name="image_category" value="{{$row->image_category}}">
