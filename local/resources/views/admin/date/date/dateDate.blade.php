...
<div class="container-fluid">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Ngày tháng</li>
      </ol>
      <!-- Example DataTables Card-->
      <div class="card mb-3">
        <div class="card-header"><i class="fa fa-table"></i> Danh mục Ngày tháng</div>
        <div class="card-body">
                ...
                <div class="row mb-2">
                    <div class="col-sm-12 col-md-12">
                        <div id="dataTable_filter" class="dataTables_filter">
                            <a role="button" class="btn btn-outline-primary" href="{{route('admin.date.date-getAdd')}}">Add</a>
                        </div>
                    </div>
                                ...
                                @if(isset($date_date))
                                 ...
                                 <tr role="row" class="odd">
                                    ...
                                    <td class='d-flex flex-row'>
                                        <a role="button" class="btn btn-sm btn-outline-primary mr-1" href="{{url('admin/date/get.edit')}}/{{$row->id}}">Edit</a>
                                        <a role="button" class="btn btn-sm btn-outline-primary" href="{{url('admin/date/set.delete')}}/{{$row->id}}">Delete</a>
                                    </td>
                                </tr>
                                    @endforeach
                                @endif
